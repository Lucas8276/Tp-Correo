...
public class TestFiltro_Contenido {
    @Test
    ...
    // Crear usuarios
        ...
        Mensaje mensaje1 = new Mensaje(usuario1, usuario2, "Asunto 1", "Cr7");
        ...
        FIltro_Base filtroContenido= new Filtro_Contenido("Cr7");
        ...
        assertTrue(mensajesFiltrados.contains(mensaje3));
